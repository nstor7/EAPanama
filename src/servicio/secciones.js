...
module.exports = [
  {
    ...
    contenido: [
      ...
      },
      {
        name: 'UL',
        content: [
        'Acústica Arquitectónica: Diseño interno del espacio',
        'Consultoría acústica de los espacios sonoros y materiales a utilizar',
        'Modelación acústica por software para optimizar el espacio',
        'Elaboración de planos constructivos y conceptuales en el tema acústico',
        'Planos detalle de elementos acústicos del proyecto'
        ]
      }
    ]  
  },
