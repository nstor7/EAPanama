  ...
  <main class="aboutUs">
    ...
    <section class="aboutSegunda">
      <article class="columna">
        <p>EA Panamá nace en la Ciudad de Panamá en el año 2014. Formada por un grupo de jóvenes emprendedores que han apostado por ofrecer una solución a los problemas acústicos que se presentan en la Ciudad de Panamá. El principal objetivo es brindar una alta calidad en todos nuestros servicios.</p>
      ...
      <article class="columna">
        <p>La <b>MISIÓN</b> de EA Panamá es proveer a nuestros clientes con Servicios, Productos y Tecnologías innovadoras, a través de la investigación y desarrollo, para dar soluciones acústicas de calidad a sus necesidades; comprometidos siempre con el medio ambiente, la sociedad y el buen servicio al cliente.</p>
        <p>Nuestra <b>VISIÓN</b>, ser la empresa de soluciones acústicas líder en la región, convirtiéndonos así en una referencia para el desarrollo, investigación, innovación y buen servicio.</p>
      </article>
    </section>
